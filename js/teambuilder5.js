const pokemonRoles = {
    ...
    kingdra: { roles: ['rainAbuser', 'sweeper'], types: ['water', 'dragon'] },
    ...
    kabutops: { roles: ['rainAbuser', 'sweeper'], types: ['rock', 'water'] },
    ...
    poliwrath: { roles: ['rainAbuser', 'sweeper'], types: ['water', 'fighting'] },
...
const teamModels = {
    balance: {
        roles: { sweeper: [0, 2], wallbreaker: [1, 2], wall: [2, 3] },
