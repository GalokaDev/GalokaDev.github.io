...
const pokemonTags = {
    ...
    "Landorus-T": ["Wall", "HazardSetter", "HazardRemover"],
    "Toxapex": ["Wall", "HazardSetter"],
    "Excadrill": ["HazardRemover", "Wallbreaker"],
    // Aggiungere ulteriori Pokémon e tag secondo il contesto competitivo
};
